...
class Controller:
    def __init__(self):
        ...
        obstacle_height = self.obstacle.image.get_size() # finds the height of the obstacle object
        self.obstacle.rect.y -= obstacle_height[1] # moves the obstacle up by it's height
    def mainloop(self):
        '''
